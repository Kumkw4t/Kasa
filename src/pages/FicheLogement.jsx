		...
		<div>
			...
			<div className="location-host-review">
				...
				<div className="location-review">
					{Array(parseInt(logement.rating,10)).fill(0).map((_,i) => <img key={`star-full${i}`} src={starFull} alt="étoile pleine" className="star-full" />)}
					{Array(parseInt(5-logement.rating,10)).fill(0).map((_,i) => <img key={`star-empty${i}`} src={starEmpty} alt="étoile vide" className="star-empty" />)}
				</div>
			</div>
